...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://yogija6595:YTP5nDCkaeYARZYC@muthiyal.7yvwzei.mongodb.net/?retryWrites=true&w=majority&appName=muthiyal")
DB_NAME = os.environ.get("DATABASE_NAME", "muthiyal")
